...
<div class="flexigrid" style='width: 100%;' data-unique-hash="<?php echo $unique_hash; ?>">
	...
	<div class="">
		<?php if(!$unset_add){?>
		<div class="tDiv2">
        	<a href='<?php echo $add_url?>' title='<?php echo $this->l('list_add'); ?> <?php echo $subject?>' class='btn btn-w-m btn-info'>
			<div class="">
				<div>
	...
	<div class="sDiv quickSearchBox" id='quickSearchBox'>
		<div class="sDiv2">
            ...
            <input type="button" value="<?php echo $this->l('list_search');?>" class="crud_search btn btn-w-m btn-info" id='crud_search'>
			
		</div>
        <div class='search-div-clear-button'>
        	<input type="button" value="<?php echo $this->l('list_clear_filtering');?>" id='search_clear' class="search_clear btn btn-w-m btn-info">
        </div>
	</div>
	<div class="pDiv">
		<div class="pDiv2">
			...
			<div class="pGroup" style="padding-top: 4px;">
				<div class="pButton first-button">
					<span><i class="fa-solid fa-angles-left" style="color: #23c6c8;font-weight: bold;font-size: 15px;"></i></span>
				</div>
				<div class="pButton prev-button">
					<span><i class="fa-solid fa-angle-left" style="color: #23c6c8;font-weight: bold;font-size: 15px;"></i></span>
				</div>
			</div>
			<div class="">
			</div>
			...
			<div class="pGroup" style="padding-top: 4px;">
				<div class="pButton next-button" >
					<span><i class="fa-solid fa-angle-right" style="color: #23c6c8;font-weight: bold;font-size: 15px;"></i></span>
				</div>
				<div class="pButton last-button">
					<span><i class="fa-solid fa-angles-right" style="color: #23c6c8;font-weight: bold;font-size: 15px;"></i></span>
				</div>
			</div>
			<div class="">
			</div>
			<div class="pGroup" style="padding-top: 4px;">
				<div class=" pButton ajax_refresh_and_loading" id='ajax_refresh_and_loading'>
					<span><i class="fa-solid fa-arrows-rotate" style="color: #23c6c8;font-weight: bold;font-size: 15px;"></i></span>
				</div>
			</div>
			<div class="">
			</div>
