...
class TotalGasto extends CI_Controller {
	...
	{
		$this->load->view('1total_gasto.php',(array)$output);
	}
	...
	public function Show()
	{
		try{
			...
			//TABLA A LEER
			$crud->set_table('total_gasto');
			//COLUMNAS A MOSTRAR
			$crud->columns('ID_Cajero','ID_Tipo_Gasto','Total','Fecha','ID_Sucursal');
			//CAMPOS A VISUALIZAR
