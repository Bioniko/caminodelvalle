...
class CajaTotal extends CI_Controller {
	...
	{
		$this->load->view('1caja_total.php',(array)$output);
	}
	...
	public function Show()
	{
		try{
			...
			//TABLA A LEER
			$crud->set_table('caja_total');
			//COLUMNAS A MOSTRAR
			$crud->columns('ID_Sucursal','ID_Cajero','Fecha','Total_Caja');
			//CAMPOS A VISUALIZAR
