...
class TotalVenta extends CI_Controller {
	...
	{
		$this->load->view('1total_venta.php',(array)$output);
	}
	...
	public function Show()
	{
		try{
			...
			//TABLA A LEER
			$crud->set_table('total_venta');
			//COLUMNAS A MOSTRAR
			$crud->columns('ID_Cajero','ID_Arqueo','ID_Sucursal','Total','Fecha');
			//CAMPOS A VISUALIZAR
